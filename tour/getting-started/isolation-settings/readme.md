Turbo Containers run application in a light-weight isolated container. Some applications may require to read local files or write to certain local directories.
